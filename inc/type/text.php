	...
	<style type="text/css">
		...
		.wrapper {
			...
			color: #222;
		   	...
		   	font-size: 1.5vmax;
		   	line-height: 1.7;
    		padding: 3vmax 4vmax 5vmax;
    		margin: 0 18vmax;

			min-height: calc(100vh - 8vmax);
		}

		@media (min-width:320px)  { .wrapper { margin: 0 2vmax; } }
		@media (min-width:480px)  { .wrapper { margin: 0 6vmax; } }
		@media (min-width:600px)  { .wrapper { margin: 0 8vmax; } }
		@media (min-width:801px)  { .wrapper { margin: 0 11vmax; } }
		@media (min-width:1025px) { .wrapper { margin: 0 14vmax; } }
		@media (min-width:1281px) { .wrapper { margin: 0 18vmax; } }
